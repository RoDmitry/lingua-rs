...
pub const BY_ALPHABET: &'static [(Alphabet, &'static [(char, char)])] = &[
    ...
    (Alphabet::Thai, THAI),
    /* (Alphabet::Adlam, ADLAM),
    (Alphabet::Ahom, AHOM),
    (Alphabet::Anatolian_Hieroglyphs, ANATOLIAN_HIEROGLYPHS),
    (Alphabet::Arabic, ARABIC),
    (Alphabet::Armenian, ARMENIAN),
    (Alphabet::Avestan, AVESTAN),
    (Alphabet::Balinese, BALINESE),
    (Alphabet::Bamum, BAMUM),
    (Alphabet::Bassa_Vah, BASSA_VAH),
    (Alphabet::Batak, BATAK),
    (Alphabet::Bengali, BENGALI),
    (Alphabet::Bhaiksuki, BHAIKSUKI),
    (Alphabet::Bopomofo, BOPOMOFO),
    (Alphabet::Brahmi, BRAHMI),
    (Alphabet::Braille, BRAILLE),
    (Alphabet::Buginese, BUGINESE),
    (Alphabet::Buhid, BUHID),
    (Alphabet::Canadian_Aboriginal, CANADIAN_ABORIGINAL),
    (Alphabet::Carian, CARIAN),
    (Alphabet::Caucasian_Albanian, CAUCASIAN_ALBANIAN),
    (Alphabet::Chakma, CHAKMA),
    (Alphabet::Cham, CHAM),
    (Alphabet::Cherokee, CHEROKEE),
    (Alphabet::Chorasmian, CHORASMIAN),
    // (Alphabet::Common, COMMON),
    (Alphabet::Coptic, COPTIC),
    (Alphabet::Cuneiform, CUNEIFORM),
    (Alphabet::Cypriot, CYPRIOT),
    (Alphabet::Cypro_Minoan, CYPRO_MINOAN),
    (Alphabet::Cyrillic, CYRILLIC),
    (Alphabet::Deseret, DESERET),
    (Alphabet::Devanagari, DEVANAGARI),
    (Alphabet::Dives_Akuru, DIVES_AKURU),
    (Alphabet::Dogra, DOGRA),
    (Alphabet::Duployan, DUPLOYAN),
    (Alphabet::Egyptian_Hieroglyphs, EGYPTIAN_HIEROGLYPHS),
    (Alphabet::Elbasan, ELBASAN),
    (Alphabet::Elymaic, ELYMAIC),
    (Alphabet::Ethiopic, ETHIOPIC),
    (Alphabet::Garay, GARAY),
    (Alphabet::Georgian, GEORGIAN),
    (Alphabet::Glagolitic, GLAGOLITIC),
    (Alphabet::Gothic, GOTHIC),
    (Alphabet::Grantha, GRANTHA),
    (Alphabet::Greek, GREEK),
    (Alphabet::Gujarati, GUJARATI),
    (Alphabet::Gunjala_Gondi, GUNJALA_GONDI),
    (Alphabet::Gurmukhi, GURMUKHI),
    (Alphabet::Gurung_Khema, GURUNG_KHEMA),
    (Alphabet::Han, HAN),
    (Alphabet::Hangul, HANGUL),
    (Alphabet::Hanifi_Rohingya, HANIFI_ROHINGYA),
    (Alphabet::Hanunoo, HANUNOO),
    (Alphabet::Hatran, HATRAN),
    (Alphabet::Hebrew, HEBREW),
    (Alphabet::Hiragana, HIRAGANA),
    (Alphabet::Imperial_Aramaic, IMPERIAL_ARAMAIC),
    // (Alphabet::Inherited, INHERITED),
    (Alphabet::Inscriptional_Pahlavi, INSCRIPTIONAL_PAHLAVI),
    (Alphabet::Inscriptional_Parthian, INSCRIPTIONAL_PARTHIAN),
    (Alphabet::Javanese, JAVANESE),
    (Alphabet::Kaithi, KAITHI),
    (Alphabet::Kannada, KANNADA),
    (Alphabet::Katakana, KATAKANA),
    (Alphabet::Kawi, KAWI),
    (Alphabet::Kayah_Li, KAYAH_LI),
    (Alphabet::Kharoshthi, KHAROSHTHI),
    (Alphabet::Khitan_Small_Script, KHITAN_SMALL_SCRIPT),
    (Alphabet::Khmer, KHMER),
    (Alphabet::Khojki, KHOJKI),
    (Alphabet::Khudawadi, KHUDAWADI),
    (Alphabet::Kirat_Rai, KIRAT_RAI),
    (Alphabet::Lao, LAO),
    (Alphabet::Latin, LATIN),
    (Alphabet::Lepcha, LEPCHA),
    (Alphabet::Limbu, LIMBU),
    (Alphabet::Linear_A, LINEAR_A),
    (Alphabet::Linear_B, LINEAR_B),
    (Alphabet::Lisu, LISU),
    (Alphabet::Lycian, LYCIAN),
    (Alphabet::Lydian, LYDIAN),
    (Alphabet::Mahajani, MAHAJANI),
    (Alphabet::Makasar, MAKASAR),
    (Alphabet::Malayalam, MALAYALAM),
    (Alphabet::Mandaic, MANDAIC),
    (Alphabet::Manichaean, MANICHAEAN),
    (Alphabet::Marchen, MARCHEN),
    (Alphabet::Masaram_Gondi, MASARAM_GONDI),
    (Alphabet::Medefaidrin, MEDEFAIDRIN),
    (Alphabet::Meetei_Mayek, MEETEI_MAYEK),
    (Alphabet::Mende_Kikakui, MENDE_KIKAKUI),
    (Alphabet::Meroitic_Cursive, MEROITIC_CURSIVE),
    (Alphabet::Meroitic_Hieroglyphs, MEROITIC_HIEROGLYPHS),
    (Alphabet::Miao, MIAO),
    (Alphabet::Modi, MODI),
    (Alphabet::Mongolian, MONGOLIAN),
    (Alphabet::Mro, MRO),
    (Alphabet::Multani, MULTANI),
    (Alphabet::Myanmar, MYANMAR),
    (Alphabet::Nabataean, NABATAEAN),
    (Alphabet::Nag_Mundari, NAG_MUNDARI),
    (Alphabet::Nandinagari, NANDINAGARI),
    (Alphabet::New_Tai_Lue, NEW_TAI_LUE),
    (Alphabet::Newa, NEWA),
    (Alphabet::Nko, NKO),
    (Alphabet::Nushu, NUSHU),
    (Alphabet::Nyiakeng_Puachue_Hmong, NYIAKENG_PUACHUE_HMONG),
    (Alphabet::Ogham, OGHAM),
    (Alphabet::Ol_Chiki, OL_CHIKI),
    (Alphabet::Ol_Onal, OL_ONAL),
    (Alphabet::Old_Hungarian, OLD_HUNGARIAN),
    (Alphabet::Old_Italic, OLD_ITALIC),
    (Alphabet::Old_North_Arabian, OLD_NORTH_ARABIAN),
    (Alphabet::Old_Permic, OLD_PERMIC),
    (Alphabet::Old_Persian, OLD_PERSIAN),
    (Alphabet::Old_Sogdian, OLD_SOGDIAN),
    (Alphabet::Old_South_Arabian, OLD_SOUTH_ARABIAN),
    (Alphabet::Old_Turkic, OLD_TURKIC),
    (Alphabet::Old_Uyghur, OLD_UYGHUR),
    (Alphabet::Oriya, ORIYA),
    (Alphabet::Osage, OSAGE),
    (Alphabet::Osmanya, OSMANYA),
    (Alphabet::Pahawh_Hmong, PAHAWH_HMONG),
    (Alphabet::Palmyrene, PALMYRENE),
    (Alphabet::Pau_Cin_Hau, PAU_CIN_HAU),
    (Alphabet::Phags_Pa, PHAGS_PA),
    (Alphabet::Phoenician, PHOENICIAN),
    (Alphabet::Psalter_Pahlavi, PSALTER_PAHLAVI),
    (Alphabet::Rejang, REJANG),
    (Alphabet::Runic, RUNIC),
    (Alphabet::Samaritan, SAMARITAN),
    (Alphabet::Saurashtra, SAURASHTRA),
    (Alphabet::Sharada, SHARADA),
    (Alphabet::Shavian, SHAVIAN),
    (Alphabet::Siddham, SIDDHAM),
    (Alphabet::SignWriting, SIGNWRITING),
    (Alphabet::Sinhala, SINHALA),
    (Alphabet::Sogdian, SOGDIAN),
    (Alphabet::Sora_Sompeng, SORA_SOMPENG),
    (Alphabet::Soyombo, SOYOMBO),
    (Alphabet::Sundanese, SUNDANESE),
    (Alphabet::Sunuwar, SUNUWAR),
    (Alphabet::Syloti_Nagri, SYLOTI_NAGRI),
    (Alphabet::Syriac, SYRIAC),
    (Alphabet::Tagalog, TAGALOG),
    (Alphabet::Tagbanwa, TAGBANWA),
    (Alphabet::Tai_Le, TAI_LE),
    (Alphabet::Tai_Tham, TAI_THAM),
    (Alphabet::Tai_Viet, TAI_VIET),
    (Alphabet::Takri, TAKRI),
    (Alphabet::Tamil, TAMIL),
    (Alphabet::Tangsa, TANGSA),
    (Alphabet::Tangut, TANGUT),
    (Alphabet::Telugu, TELUGU),
    (Alphabet::Thaana, THAANA),
    (Alphabet::Thai, THAI),
    (Alphabet::Tibetan, TIBETAN),
    (Alphabet::Tifinagh, TIFINAGH),
    (Alphabet::Tirhuta, TIRHUTA),
    (Alphabet::Todhri, TODHRI),
    (Alphabet::Toto, TOTO),
    (Alphabet::Tulu_Tigalari, TULU_TIGALARI),
    (Alphabet::Ugaritic, UGARITIC),
    (Alphabet::Vai, VAI),
    (Alphabet::Vithkuqi, VITHKUQI),
    (Alphabet::Wancho, WANCHO),
    (Alphabet::Warang_Citi, WARANG_CITI),
    (Alphabet::Yezidi, YEZIDI),
    (Alphabet::Yi, YI),
    (Alphabet::Zanabazar_Square, ZANABAZAR_SQUARE), */
];
