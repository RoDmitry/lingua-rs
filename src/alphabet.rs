...
fn alphabet_langs_chars(a: Alphabet) -> &'static [Language] {
    match a {
        ...
        Alphabet::Cuneiform => &[Language::Sumerian, Language::Akkadian, Language::Hittite],
        ...
        Alphabet::Kaithi => &[Language::Bhojpuri, Language::Magahi, Language::Maithili],
        ...
        Alphabet::Mahajani => &[Language::Hindi, Language::Punjabi, Language::Marwari],
        ...
        Alphabet::Old_Italic => &[Language::Etruscan, Language::Oscan, Language::Umbrian],
        ...
        Alphabet::Soyombo => &[Language::Mongolian, Language::Tibetan, Language::Sanskrit],
        ...
        Alphabet::Tai_Tham => &[Language::NorthernThai, Language::TaiLue, Language::Lao],
        ...
        Alphabet::Zanabazar_Square => &[Language::Mongolian, Language::Tibetan, Language::Sanskrit],
    }
}
